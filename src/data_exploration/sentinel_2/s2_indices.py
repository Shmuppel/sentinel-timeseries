...
def calculate_indices():
    ...
    # load green band
    green_image = "resources/images/T31UFU_20210823T105031_B03.jp2"
    green_array, geometry_transform = get_image_data(green_image, aoi_json)
    # # load NIR Band
    nir_image = "resources/images/T31UFU_20210823T105031_B08.jp2"
    nir_array,_ = get_image_data(nir_image, aoi_json)
    # load SWIR Data
    swir_image = "resources/images/T31UFU_20210823T105031_B11.jp2"
