...
plot1_indices(parcels, 'count of pooling_px', '2020-02-18: ')

s1_stats(full_stats_20210619, parcels, 'pooling_px')
plot1_indices(parcels, 'count of pooling_px', '2021-06-19: ')

s1_stats(full_stats_20211022, parcels, 'pooling_px')
plot1_indices(parcels, 'count of pooling_px', '2021-10-22: ')
