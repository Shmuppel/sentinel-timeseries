...
def main():
    ...
    # Open with gdal
    vh_backscatter_dry = gdal.Open('src/data_exploration/sentinel_1/temp_tiff/'
                                   'S1A_IW_GRDH_1SDV_20211017T171716_20211017T171741_040162_04C1B1_6C50.SAFE/'
                                   'measurement/s1a-iw-grd-vh-20211017t171716-20211017t171741-040162-04c1b1-002.tiff')
    vh_backscatter_wet = gdal.Open('src/data_exploration/sentinel_1/temp_tiff/'
                                   'S1A_IW_GRDH_1SDV_20211022T172522_20211022T172547_040235_04C439_981A.SAFE/'
                                   'measurement/s1a-iw-grd-vh-20211022t172522-20211022t172547-040235-04c439-002.tiff')
    # Warp to epsg 4326
    gdal.Warp('src/data_exploration/sentinel_1/temp_tiff/vh_warp_dry.tiff', vh_backscatter_dry,
              dstSRS="EPSG:4326")
    gdal.Warp('src/data_exploration/sentinel_1/temp_tiff/vh_warp_wet.tiff', vh_backscatter_wet,
              dstSRS="EPSG:4326")
    ...
    vh_dry = get_image_data("src/data_exploration/sentinel_1/temp_tiff/vh_warp_dry.tiff", study_area)
    vh_wet = get_image_data("src/data_exploration/sentinel_1/temp_tiff/vh_warp_wet.tiff", study_area, vh_dry.shape)
